...
export const ZIELFELDER: ZielFeld[] = [
  ...
  { key: 'geburtsdatum', label: 'Geburtsdatum (TT.MM.JJJJ)' },
  { key: 'adresse', label: 'Adresse (Straße)' },
  { key: 'ort', label: 'Ort / PLZ' },
  { key: 'telefon', label: 'Telefon' },
  { key: 'email', label: 'E-Mail' },
  { key: 'pflegegrad', label: 'Pflegegrad' },
  { key: 'kostentraeger', label: 'Kostenträger (gesetzlich/privat)' },
...
const SYNONYME: Record<string, string[]> = {
  ...
  geburtsdatum: ['geburtsdatum', 'geburtstag', 'gebdatum', 'gebdat', 'geburt', 'birthdate', 'dob'],
  ...
  kostentraeger: ['kostentraeger', 'kostentraegerart', 'versicherungsart', 'versichertenstatus', 'kassenart', 'gkvpkv'],
  krankenkasse: ['krankenkasse', 'kasse', 'krankenversicherung', 'krankenversicherer', 'versicherung', 'kk'],
